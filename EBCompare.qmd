...
list.files("SCRIPTS/COMPARE", pattern = "\\.R$", full.names = TRUE) %>% 
  purrr::walk(source)
...
temp <- readRDS("OUTPUT/Comparison_Models/out_list_2024-05-25.RDS")
list2env(temp, envir = .GlobalEnv)
temp <- readRDS("OUTPUT/Comparison_Models/prop_list_2024-05-25.RDS")
list2env(temp, envir = .GlobalEnv)
...
if(params$fit_prop){
  ...
  saveRDS(savelist, "Output/Comparison_Models/prop_list_2024-05-25.RDS",
          compress = FALSE)
}
...
if(params$fit_out){
  ...
  saveRDS(savelist, "Output/Comparison_Models/out_list_2024-05-25.RDS", 
          compress = FALSE)
}
