...
<!-- The outcome profile shows the median *treatment effect* for each surgery-outcome combination. Color coding indicates the probability that the treatment effect exceeds clinically meaningful threshold chosen by a panel of experts.   -->

<!-- **Treatment Effect = &Delta;~Treated~ - &Delta;~Control~**   -->
